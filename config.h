...
static const char *brightness[2][4] = { {"xbacklight", "-inc", "10%", NULL},{"xbacklight", "-dec", "10%", NULL} };
static const char *volume[3][4] = { {"pactl", "set-sink-volume", "@DEFAULT_SINK@", "+10%" },{ "pactl", "set-sink-volume", "@DEFAULT_SINK@", "-10%" },{ "pactl", "set-sink-mute", "@DEFAULT_SINK@", "toggle" } };
